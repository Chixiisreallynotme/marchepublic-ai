...
## Gates
- [x] G1: Le typage strict passe sans erreur
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/home/chixi/.gemini/antigravity/scratch/marchepublic-ai; path=faf051d727cf/18 entries; output=TYPECHECK_GATE_OK
- [x] G2: La suite de tests vitest est 100% verte
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/home/chixi/.gemini/antigravity/scratch/marchepublic-ai; path=faf051d727cf/18 entries; output=TESTS_GATE_OK
- [x] G3: Toutes les routes applicatives répondent HTTP 200
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/home/chixi/.gemini/antigravity/scratch/marchepublic-ai; path=faf051d727cf/18 entries; output=ROUTES_GATE_OK
- [x] G4: Le PDF CERFA DC1 se génère réellement (%PDF magic bytes)
  CHECK: bash -c 'curl -s -m 20 http://localhost:3000/api/cerfa/cerfa-dc1-novatech/pdf | head -c5 | grep -q "%PDF-" && echo PDF_GATE_OK'
  EXPECT: PDF_GATE_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/home/chixi/.gemini/antigravity/scratch/marchepublic-ai; path=faf051d727cf/18 entries; output=PDF_GATE_OK
- [x] G5: La recherche Sirene interroge le registre ETALAB réel (données factuelles)
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/home/chixi/.gemini/antigravity/scratch/marchepublic-ai; path=faf051d727cf/18 entries; output=SIRENE_GATE_OK
